...
DOM.input.addEventListener('focus', EVENTS.moveCursorToEnd)
DOM.input.addEventListener('paste', EVENTS.moveCursorToEnd)
DOM.input.addEventListener('blur', LAYOUT.showPlaceholder)
DOM.commSwitch.addEventListener('click', EVENTS.onCommSwitchClick)
